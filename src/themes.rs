...
pub struct Theme {
    ...
    pub drawing_arrow_btn_bg: Color,
    pub drawing_arrow_btn: Color,
    pub drawing_line_btn_bg: Color,
    pub drawing_line_btn: Color,
...
pub fn velo_light() -> Theme {
    Theme {
        ...
        drawing_arrow_btn_bg: Color::rgb(0.9, 0.9, 0.9),
        drawing_arrow_btn: Color::BLUE,
        drawing_line_btn_bg: Color::rgb(0.9, 0.9, 0.9),
        drawing_line_btn: Color::BLUE,
...
pub fn velo_dark() -> Theme {
    Theme {
        ...
        drawing_pencil_btn: Color::RED,
        drawing_arrow_btn_bg: Color::GRAY,
        drawing_arrow_btn: Color::BLUE,
        drawing_line_btn_bg: Color::GRAY,
        drawing_line_btn: Color::BLUE,
